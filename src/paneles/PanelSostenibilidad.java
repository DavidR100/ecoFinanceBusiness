...
public class PanelSostenibilidad extends javax.swing.JPanel {
    ...
    //private double totalCO2 = 0; -> AppState.totalCO2Ahorrado
    //private int totalAcciones = 0; -> AppState.totalAccionesSostenibles
    /**
    ...
    private JPanel buildFilaAccion(String emoji, String nombre, String desc, JTextField campo, double factor) {
        ...
        btnOK.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                btnOK.setBackground(UITheme.VERDE_MEDIO);
            }
    ...
    private void registrarAccion(JTextField campo, double factor, String nombre) {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    + "Total sesión: " + String.format("%.3f", AppState.totalCO2Ahorrado) + " kg",
    ...
    private void actualizarIndicador() {
        // === CO2 TOTAL ===
        lblCO2Total.setText(String.format("%.3f kg CO₂", AppState.totalCO2Ahorrado));

        // === ACCIONES ===
        lblAcciones.setText(AppState.totalAccionesSostenibles + " acciones sostenibles registradas");
        ...
        if (AppState.totalCO2Ahorrado == 0) {
            nivel = "SIN ACCIONES AÚN";
            pct = 0;
            insigniaTitulo = "SEMILLA VERDE";
            insigniaDesc = "Pequeño paso, gran dirección";
            insigniaEmoji = "🌱";
        } else if (AppState.totalCO2Ahorrado < 1) {
            nivel = "INICIO SOSTENIBLE";
            pct = 20;
            insigniaTitulo = "SEMILLA VERDE";
            insigniaDesc = "Pequeño paso, gran dirección";
            insigniaEmoji = "🌱";
        } else if (AppState.totalCO2Ahorrado < 3) {
            nivel = "PIZZERÍA RESPONSABLE";
            pct = 40;
            insigniaTitulo = "HOJA SOSTENIBLE";
            insigniaDesc = "Impacto real y medible · < 3 kg CO₂";
            insigniaEmoji = "🍃";
        } else if (AppState.totalCO2Ahorrado < 6) {
            nivel = "NEGOCIO ECO-AMIGABLE";
            pct = 60;
            insigniaTitulo = "ÁRBOL PROTECTOR";
            insigniaDesc = "Excelente contribución · 3–6 kg CO₂";
            insigniaEmoji = "🌳";
        } else if (AppState.totalCO2Ahorrado < 10) {
            nivel = "EMPRESA SOSTENIBLE";
            pct = 80;
            insigniaTitulo = "ÁRBOL PROTECTOR";
            insigniaDesc = "Excelente contribución · 5–10 kg CO₂";
            insigniaEmoji = "🌲";
        } else {
            nivel = "LÍDER AMBIENTAL";
            pct = 100;
        ...
        // === EQUIVALENCIAS ===
        double arboles = AppState.totalCO2Ahorrado / 21.77;
        double km = AppState.totalCO2Ahorrado / 0.21;
        double bolsas = AppState.totalCO2Ahorrado / 0.033;
