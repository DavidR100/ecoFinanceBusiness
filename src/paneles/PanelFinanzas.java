...
public class PanelFinanzas extends javax.swing.JPanel {
    ...
    // === DATOS ===
    //private double totalIngresos = 0; -> AppState.totalIngresos
    //private double totalGastos = 0; -> AppState.totalGastos
    ...
    public PanelFinanzas(EFBPrincipal app) {
        initComponents();
        this.app = app;
...
// === BOTONES ===
        ...
        btnRegistrar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                btnRegistrar.setBackground(UITheme.VERDE_MEDIO);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnRegistrar.setBackground(UITheme.VERDE_PRINCIPAL);
            }
        });
    ...
    private JPanel buildTotalItem(String etiqueta, String valor, Color color, boolean borde) {
        ...
        if (borde) {
            item.setBorder(new EmptyBorder(0, 0, 0, 20));
        }
    ...
    private void actualizarTotales() {
        ...
        lblTotalIngresos.setText("$" + String.format("%,.0f", AppState.totalIngresos));
        lblTotalGastos.setText("$" + String.format("%,.0f", AppState.totalGastos));
        lblSaldo.setText("$" + String.format("%,.0f", saldo));
